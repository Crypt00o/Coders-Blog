...
const create=async(req:Request,res:Response):Promise<void>=>{
    try{
        const newArticle:Article={user_id:req.params.user_id as string, article_title:req.body.title as string , article_body:req.body.article as string,lastupdate_date:null }
